...
import { accessoryProducts } from "@/app/data/products";

const CATEGORIES = ["All", "Jewelry"];
...
export default function AccessoriesPage() {
  ...
  const filtered = useMemo(
    () =>
      activeFilter === "All"
        ? accessoryProducts
        : accessoryProducts.filter((p) => p.category === activeFilter),
    [activeFilter],
  );
      ...
      <main className="flex-1 px-10 py-14">
        ...
        <div className="flex items-end justify-between mb-12">
          <div>
            ...
            <h1 className="font-serif text-5xl text-[#2C2A29] tracking-tight">Accessories</h1>
          </div>
