...
export const clothingProducts: Product[] = [
  ...
  { id: "c21", name: "Ribbed Cream Cashmere Cardigan",    category: "Knitwear",  price: "$520",   from: "#EAE0D0", via: "#F2EAE0", to: "#FAF5EE", isBestseller: true, imagePath: "/clothes/Ribbed-Cream-Cardigan.png" },
  { id: "c25", name: "Oatmeal Merino Turtleneck",         category: "Knitwear",  price: "$340",   from: "#D8CFC0", via: "#E8E0D2", to: "#F5F0E8", isNew: true },
  { id: "c26", name: "Sage Green Loose-Knit Vest",        category: "Knitwear",  price: "$280",   from: "#8CA88A", via: "#B0C4AE", to: "#D8E4D6" },
  { id: "c27", name: "Camel Chunky-Knit Pullover",        category: "Knitwear",  price: "$395",   from: "#C8A868", via: "#DCC090", to: "#EED8B0", isBestseller: true },
